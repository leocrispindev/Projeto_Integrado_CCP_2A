			...
			<section class="bloco bloco-no-overflow" id="bootstrap">
				...
				<div class="container-fluid">
					<table class="table table-dark">
						...
						<tbody>
							<tr>
								<th scope="row" id="botao-deletar" class="nao-deleta-linha"><a id="deletaLinhaTabela"><img src="./resources/assets/trash-solid.png" alt="deletar" class="deleta_turma"/></a></th>
								<td>CCP1B1-MCA3</td>
								<td>Chocolate</td>
